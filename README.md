...
This is an end-to-end build guide and installation tutorial with full parts/hardware listing, download for pretrained YOLOv3 weights for detecting "Human head", with Arduino and ROS source code to build a robotic pan/tilt turret that uses machine learning and relatively inexpensive hardware to detect and track the nearest "human head".  The code and weights files for this are hosted from a google drive download link included in this readme (simplifies download and install process), and you can see a few examples of it in action in the gifs below:


<img src="https://github.com/WyattAutomation/YOLOv3-ROS-Robotic-Head-Shot-Turret-/blob/master/orbbec2.gif" height="400" width="285" align="left">  
<p align="center">
  <img src="https://github.com/WyattAutomation/YOLOv3-ROS-Robotic-Head-Shot-Turret-/blob/master/kinectshot.gif" height="400" width="550">
</p>
...
I've tested this setup process from start to finish as of April 26 2020 with Xubuntu 18.04 and can confirm it works without issue.  You can download Xubuntu 18.04 from here, and simply burn the iso to a thumb drive using rufus or Etcher: https://xubuntu.org/release/18-04/
